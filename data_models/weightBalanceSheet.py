...
records = {'机型/架机：': 'C919/10106',
           '重量平衡表编号：': 'WAB-C919-10106-0045',
           '重量平衡表版本：': 'A'}
records2 = {'任务单编号：': 'FTC-C919-10106-0064',
            '试验空机重量重心依据：': 'T-C817JB199',
            '配载数据依据：': ' ALS-C919-10106-004'}
records3 = {'试验内容：': '飞行',
            '上机人数': '6人',
            '编制日期：': '2020-09-01'}
records4 = {'试验空机重量(W)':
